...
public class DepartmentContract extends BaseContract {
    ...
    public static final String TABLE_COLUMN_ID = DatabaseConstant.createTableColumnNameConstant(TABLE_DEPARTMENT_STRING, COLUMN_ID);
    public static final String TABLE_COLUMN_NAME = DatabaseConstant.createTableColumnNameConstant(TABLE_DEPARTMENT_STRING, COLUMN_NAME);
    public static final String TABLE_COLUMN_CREATED_AT = DatabaseConstant.createTableColumnNameConstant(TABLE_DEPARTMENT_STRING,COLUMN_CREATED_AT);
    ...
    public static List<String> TABLE_COLUMN_NAME_LIST = new ArrayList<String>() {
        {
            for (String columnName : COLUMN_NAME_LIST) {
                add(DatabaseConstant.createTableColumnNameConstant(TABLE_DEPARTMENT_STRING, columnName));
            }
        }
    };
}
